...
public class ApplicationConfig {
    ...
    @Bean
    public MessageSenderSrv.Iface dudoserClient(
            @Value("${service.dudoser.url}") Resource resource,
            @Value("${service.dudoser.networkTimeout}") int networkTimeout
    ) throws IOException {
        return new THSpawnClientBuilder()
                .withNetworkTimeout(networkTimeout)
    ...
    @Bean
    public FistfulAdminSrv.Iface fistfulClient(
            @Value("${service.fistful.url}") Resource resource,
