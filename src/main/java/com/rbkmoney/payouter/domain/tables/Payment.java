...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = -1121449302;
    ...
    /**
     * The column <code>sht.payment.contract_id</code>.
     */
    public final TableField<PaymentRecord, String> CONTRACT_ID = createField("contract_id", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>sht.payment.party_revision</code>.
     */
