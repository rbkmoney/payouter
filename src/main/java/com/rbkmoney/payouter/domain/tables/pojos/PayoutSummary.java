...
public class PayoutSummary implements Serializable {
    ...
    private static final long serialVersionUID = -1385069708;

    private Long                       id;
    private String                     payoutId;
    private PayoutSummaryOperationType cashFlowType;
    ...
    public PayoutSummary(
        Long                       id,
        String                     payoutId,
        PayoutSummaryOperationType cashFlowType,
        Integer                    count,
        Long                       amount,
        Long                       fee,
        String                     currencyCode,
    ...
    public void setCashFlowType(PayoutSummaryOperationType cashFlowType) {
        this.cashFlowType = cashFlowType;
    }
