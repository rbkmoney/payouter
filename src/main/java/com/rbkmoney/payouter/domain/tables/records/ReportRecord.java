...
public class ReportRecord extends UpdatableRecordImpl<ReportRecord> implements Record9<Long, LocalDateTime, String, String, String, String, ReportStatus, LocalDateTime, String> {

    private static final long serialVersionUID = 1412035620;
     ...
     */
    @Override
    public Row9<Long, LocalDateTime, String, String, String, String, ReportStatus, LocalDateTime, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, LocalDateTime, String, String, String, String, ReportStatus, LocalDateTime, String> valuesRow() {
     ...
     */
    @Override
    public ReportRecord values(Long value1, LocalDateTime value2, String value3, String value4, String value5, String value6, ReportStatus value7, LocalDateTime value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReportRecord(Long id, LocalDateTime createdAt, String payoutIds, String name, String content, String description, ReportStatus status, LocalDateTime lastSendAt, String encoding) {
        super(Report.REPORT);
