...
public class CashFlowDescriptionRecord extends UpdatableRecordImpl<CashFlowDescriptionRecord> implements Record9<Long, String, CashFlowType, Integer, Long, Long, String, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = 946273919;
     ...
     */
    @Override
    public Row9<Long, String, CashFlowType, Integer, Long, Long, String, LocalDateTime, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, String, CashFlowType, Integer, Long, Long, String, LocalDateTime, LocalDateTime> valuesRow() {
     ...
     */
    @Override
    public CashFlowDescriptionRecord value2(String value) {
        setPayoutId(value);
        return this;
    }
     ...
     */
    @Override
    public CashFlowDescriptionRecord values(Long value1, String value2, CashFlowType value3, Integer value4, Long value5, Long value6, String value7, LocalDateTime value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CashFlowDescriptionRecord(Long id, String payoutId, CashFlowType cashFlowType, Integer count, Long amount, Long fee, String currencyCode, LocalDateTime fromTime, LocalDateTime toTime) {
        super(CashFlowDescription.CASH_FLOW_DESCRIPTION);
