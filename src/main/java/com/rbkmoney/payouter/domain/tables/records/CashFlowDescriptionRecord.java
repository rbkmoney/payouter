...
public class CashFlowDescriptionRecord extends UpdatableRecordImpl<CashFlowDescriptionRecord> implements Record7<Long, Long, CashFlowType, Integer, Long, String, String> {

    private static final long serialVersionUID = -1838055160;
     ...
     */
    @Override
    public Row7<Long, Long, CashFlowType, Integer, Long, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, CashFlowType, Integer, Long, String, String> valuesRow() {
     ...
     */
    @Override
    public CashFlowDescriptionRecord values(Long value1, Long value2, CashFlowType value3, Integer value4, Long value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CashFlowDescriptionRecord(Long id, Long payoutId, CashFlowType cashFlowType, Integer count, Long amount, String currencyCode, String description) {
        super(CashFlowDescription.CASH_FLOW_DESCRIPTION);
